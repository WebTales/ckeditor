                            ...
                            children: [
                                {
                                    ...
                                    setup: function( type, element ) {
                                        ...
                                        if ( type == IMAGE ) {
                                            var tempElemClasses=element.getAttribute('class');
                                            if (!tempElemClasses){
                                                tempElemClasses="img-responsive";
                                            } else if (tempElemClasses.indexOf("img-responsive")==-1){
                                                tempElemClasses=tempElemClasses+" img-responsive";
                                            }
                                            this.setValue(tempElemClasses);
                                        }
                                    },
                                    commit: function( type, element ) {
